...
import "./libraries/OldBerryTransfer.sol";
import "./libraries/OldBerryDispute.sol";
import "./libraries/OldBerryStake.sol";
import "./libraries/OldBerryLibrary.sol";
...
contract OldBerry{
    ...
    using OldBerryDispute for BerryStorage.BerryStorageStruct;
    using OldBerryLibrary for BerryStorage.BerryStorageStruct;
    using OldBerryStake for BerryStorage.BerryStorageStruct;
    using OldBerryTransfer for BerryStorage.BerryStorageStruct;
