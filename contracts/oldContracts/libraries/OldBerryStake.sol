...
library OldBerryStake {
    ...
    */
    function init(BerryStorage.BerryStorageStruct storage self) public{
        ...
        OldBerryTransfer.updateBalanceAtNow(self.balances[address(this)], 2**256-1 - 6000e18);
        ...
        for(uint i=0;i<6;i++){//6th miner to allow for dispute
            ...
            OldBerryTransfer.updateBalanceAtNow(self.balances[_initalMiners[i]],1000e18);
    ...
    */
    function requestStakingWithdraw(BerryStorage.BerryStorageStruct storage self) public {
        ...
        OldBerryDispute.updateDisputeFee(self);
    ...
    */
    function newStake(BerryStorage.BerryStorageStruct storage self, address staker) internal {
        require(OldBerryTransfer.balanceOf(self,staker) >= self.uintVars[keccak256("stakeAmount")]);
