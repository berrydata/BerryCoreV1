...
library BerryStake {
    ...
    */
    function init(BerryStorage.BerryStorageStruct storage self) public {
        ...
        // 5000000 for miner[4], 1250000 for team[5]
        // BerryTransfer.updateBalanceAtNow(self.balances[address(this)], 2**256 - 1 - 6000e18);
        BerryTransfer.updateBalanceAtNow(self.balances[address(this)], 6250000e18);
        ...
        // 2500000 for mining liquidity[1], 3000000-6000 for ecosystem fund[2] (deduct for initial startup), 2000000 for ifo[3]
        BerryTransfer.updateBalanceAtNow(self.balances[msg.sender], 7494000e18);

        //update the total suppply
        self.uintVars[keccak256("total_supply")] += 7500000e18; // [1]+[2]+[3]
        //set Constants
