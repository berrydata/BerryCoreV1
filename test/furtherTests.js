...
//         await utilities.setBerryMaster(oracle.address);
...
//         assert(await oracle.getAddressVars(web3.utils.keccak256("berryContract")) == newOracle.address, "berryContract should be Berry Base");
...
//         await helper.advanceTime(86400 * 8);
//         await web3.eth.sendTransaction({to: oracle.address,from:accounts[i],gas:7000000,data:oracle2.methods.tallyVotes(1).encodeABI()})
//         assert(await oracle.getAddressVars(web3.utils.keccak256("berryContract")) == newOracle.address, "vote should have failed");
//     });
