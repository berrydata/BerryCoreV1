...
//         oracle = await BerryMaster.new(web3.utils.toChecksumAddress(oracleBase.address));
...
//       await helper.advanceTime(86400 * 10);
//       await reader.getBerryValues(endTime);
...
//       await helper.advanceTime(86400 * 10);
//       await reader.getBerryValues(await reader.endDateTime.call());
//       await reader.settleContracts();
...
//       await reader.getBerryValues(startTime);
//       await helper.advanceTime(86400 * 10);
//       await reader.setValue(await reader.endDateTime.call(), 500);
//       //launch and mine one on Berry
//       //set up the contracts to handle getting the value
